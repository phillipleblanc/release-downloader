...
const util = __webpack_require__(675);
let fs;
let tunnel;
var HttpCodes;
(function (HttpCodes) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.message
                ...
                const chunk = typeof data === "string"
                    ? Buffer.from(data, encodingCharset)
                    : data;
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    if (isGzippedEncoded) {
                        // Process GZipped Response Body HERE
...
class HttpClient {
    constructor(userAgent, handlers, requestOptions) {
        ...
        if (requestOptions) {
            ...
            if (this._certConfig) {
                ...
                if (this._certConfig.certFile &&
                    fs.existsSync(this._certConfig.certFile)) {
                    this._cert = fs.readFileSync(this._certConfig.certFile, "utf8");
                }
                if (this._certConfig.keyFile &&
                    fs.existsSync(this._certConfig.keyFile)) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (numTries < maxTries) {
                try {
                    ...
                    if (err &&
                        err.code &&
                        NetworkRetryErrors.indexOf(err.code) > -1 &&
                        numTries < maxTries) {
    ...
    _getAgent(parsedUrl) {
        ...
        let useProxy = proxy.proxyUrl &&
            proxy.proxyUrl.hostname &&
            !this._isMatchInBypassProxyList(parsedUrl);
...
var util = __webpack_require__(861);
...
var utils = __webpack_require__(861);
...
var parse = __webpack_require__(514);
var formats = __webpack_require__(293);
...
Object.defineProperty(exports, "__esModule", { value: true });
const qs = __webpack_require__(444);
const url = __webpack_require__(835);
...
const thc = __importStar(__webpack_require__(225));
