...
var formats = __webpack_require__(714);
...
const util = __webpack_require__(773);
let fs;
let tunnel;
var HttpCodes;
(function (HttpCodes) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (numTries < maxTries) {
                ...
                while (HttpRedirectCodes.indexOf(response.message.statusCode) != -1
                    ...
                    if (!!this.requestOptions && this.requestOptions.removeHeadersOnRedirect && this.requestOptions.removeHeadersOnRedirect.length) {
                        for (const headerToRemove of this.requestOptions.removeHeadersOnRedirect) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const qs = __webpack_require__(827);
const url = __webpack_require__(835);
...
var parse = __webpack_require__(781);
var formats = __webpack_require__(714);
...
const thc = __importStar(__webpack_require__(740));
const API_ROOT = "https://api.github.com/repos";
const httpClient = new thc.HttpClient("gh-api-client", undefined, { removeHeadersOnRedirect: ["Authorization"] });
